...
def load_examples(user_hint = None):
    ...
    with tf.name_scope("load_images"):
        ...
        random_sketch_width = tf.clip_by_value(tf.random_uniform(shape=[], minval=0, maxval=a.dilation_sketch_max_width + 1, dtype=tf.int32,
