...
input_dirs = ["/mnt/06CAF857CAF84489/datasets/mnt/data_drive/home/ubuntu/pixiv_new_128_w_face_reshape_combined/test",
              ...
              "/media/jerryli27/1ACC040DCC03E1BD/pixiv_datasets/sketch_convert_refactored_bn_train_sketch_mix_0_test/images",
...
for i in [11]:# range(len(input_dirs)):  # [6, 11, 13, 14, 15, 16]:
    for hint_mode in input_type_hint_modes[input_types[i]]:
        ...
        for sketch_mode in input_type_sketch_modes[input_types[i]]:
            ...
            os.system("/usr/bin/python pix2pix_w_hint_lab_wgan_larger_sketch_mix_cond_refactored.py --mode test --output_dir "
                      "%s "
                      "--max_epochs 20 --input_dir %s --which_direction AtoB "
                      "--display_freq=1000 --gray_input_a --batch_size 1 --lr 0.0008 --gpu_percentage 0.25 "
