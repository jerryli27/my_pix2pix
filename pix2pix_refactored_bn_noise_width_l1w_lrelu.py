...
def load_examples(input_dir, user_hint = None):
    if not os.path.exists(input_dir):
        raise Exception("input_dir %s does not exist" %(input_dir))

    input_paths = get_all_image_paths(input_dir)
...
def main():
    ...
    examples = load_examples(input_dir=a.input_dir,user_hint=user_hint)
    examples = load_examples(input_dir=a.input_dir,user_hint=user_hint)
