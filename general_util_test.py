...
class TestDataUtilMethods(unittest.TestCase):
    ...
    def test_get_all_image_paths(self):
        ...
        f.close()
        actual_answer = get_all_image_paths(dirpath + '/')
    ...
    def test_read_and_resize_images(self):
        ...
        content_dirs = get_all_image_paths(content_folder + '/')
    ...
    def test_imread_bw(self):
        ...
        actual_output = imread(get_all_image_paths(content_folder + '/')[0], bw=True)
    ...
    def test_imread_and_imsave_utf8(self):
        ...
        actual_output = imread(get_all_image_paths(content_folder + '/')[0])
    ...
    def test_read_palette(self):
        content = "/home/jerryli27/pixiv_images/color/Rella (163536)/14080177_p0 - らくがき.jpg	(200, 185, 190);(141, 139, 160);(129, 100, 126);(102, 114, 147);(93, 83, 117);(77, 58, 83);(118, 64, 99);(92, 100, 108);(148, 116, 116)\n/home/jerryli27/pixiv_images/color/Rella (163536)/14990760_p0 - LOL-lots of laugh-.jpg	(217, 175, 177);(156, 87, 117);(141, 146, 161);(92, 100, 144);(70, 56, 111);(68, 42, 69);(219, 179, 96);(132, 65, 80);(87, 87, 90)\n"
        dirpath = tempfile.mkdtemp()
        try:
            filename = os.path.join(dirpath, "test.tsv")
            with open(filename, "w") as f:
                f.write(content)
            actual_output = read_palette(filename)
            expected_image_paths = ["/home/jerryli27/pixiv_images/color/Rella (163536)/14080177_p0 - らくがき.jpg", "/home/jerryli27/pixiv_images/color/Rella (163536)/14990760_p0 - LOL-lots of laugh-.jpg"]
            expected_palettes = [[(200, 185, 190),(141, 139, 160),(129, 100, 126),(102, 114, 147),(93, 83, 117),(77, 58, 83),(118, 64, 99),(92, 100, 108),(148, 116, 116)], [(217, 175, 177),(156, 87, 117),(141, 146, 161),(92, 100, 144),(70, 56, 111),(68, 42, 69),(219, 179, 96),(132, 65, 80),(87, 87, 90)]]
            expected_output = (expected_image_paths, expected_palettes)
