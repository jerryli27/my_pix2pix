...
a = parser.parse_args()
assert not a.use_hint and a.train_sketch and not a.use_sketch_loss
...
SKETCH_VAR_SCOPE_PREFIX = "addinfo_"
...
def load_examples(user_hint = None):
    ...
    with tf.name_scope("target_images"):
        ...
        target_images = sketch_extractor(target_images, max_val=1.0, min_val=-1.0, color_space="lab" if a.lab_colorization else "rgb")
