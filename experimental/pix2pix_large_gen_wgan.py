#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Only the generator is modified to be larger and deeper. Discriminator stays the same."""
...
parser.add_argument("--gan_start_epoch", type=int, help="number of training epochs")
    ...
    def create_discriminator(discrim_inputs, discrim_targets):
        ...
        for i in range(n_layers):
            with tf.variable_scope("layer_%d" % (len(layers) + 1)):
                ...
                convolved = conv(layers[-1], out_channels, stride=stride, shift=4)
        ...
        with tf.variable_scope("layer_%d" % (len(layers) + 1)):
            ...
            # With WGAN, sigmoid for the last layer is no longer needed
            convolved = conv(rectified, out_channels=1, stride=1,shift=4)
            layers.append(convolved)
...
def main():
    ...
    with sv.managed_session(config=config) as sess:
        ...
        if a.mode == "test":
            ...
            if a.gan_start_epoch is not None:
                gan_start_steps = examples.steps_per_epoch * a.gan_start_epoch
            else:
                gan_start_steps = max_steps / 2
...
"""
"""
python pix2pix_large_gen_wgan.py --mode train --output_dir pixiv_full_128_large_gen_wgan_train --max_epochs 20 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/train --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --gan_start_epoch=6
python pix2pix_large_gen_wgan.py --mode train --output_dir pixiv_full_128_large_gen_wgan_sanity_check --max_epochs 200 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/test --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --gpu_percentage 0.45
python pix2pix_large_gen_wgan.py --mode train --output_dir pixiv_full_128_large_gen_wgan_tiny --max_epochs 200 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/tiny --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 1 --gpu_percentage 0.45
"""

"""
python pix2pix_large_gen_wgan.py --mode test --output_dir pixiv_full_128_large_gen_wgan_test --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/test --checkpoint pixiv_full_128_large_gen_wgan_train
python pix2pix_large_gen_wgan.py --mode test --output_dir pixiv_full_128_large_gen_wgan_tiny_test --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/test --checkpoint pixiv_full_128_large_gen_wgan_tiny --gpu_percentage 0.45
"""