...
def main():
    ...
    model = create_model(inputs, targets, targets_bin)
...
"""
# Sanity check
python pix2pix_w_hint_lab_wgan_rgbbin.py --mode train --output_dir pix2pix_w_hint_lab_wgan_rgbbin_sanity_check --max_epochs 2000 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/tiny --which_direction AtoB --display_freq=200 --gray_input_a --batch_size 1 --lr 0.0008 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --use_bin
# Train
...
# Train with bin
python pix2pix_w_hint_lab_wgan_rgbbin.py --mode train --output_dir pixiv_downloaded_128_w_hint_lab_wgan_rgbbin --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_128_combined/train --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --use_bin
# Train 512
