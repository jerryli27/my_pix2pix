...
parser.add_argument("--hint_prob", type=float, default=0.5, help="Probability of giving hint during training or testing.")
...
parser.add_argument("--no_wgan", dest="wgan", action="store_false", help="don't use wgan loss")
parser.set_defaults(wgan=True)
...
def load_examples(user_hint = None):
    ...
    def append_hint(inputs, targets, user_hint = None, hint_prob = 0.5):
        num_hints = 40
        ...
        if user_hint is None:
            ...
            with tf.control_dependencies([clear_hint_op,hints]):
                ...
                half_constant = tf.constant(hint_prob)
    ...
    with tf.name_scope("input_images"):
        ...
        if a.use_hint:
            input_images, input_hints = append_hint(input_images, target_images, user_hint=user_hint, hint_prob=a.hint_prob)
...
def create_model(inputs, targets):
    ...
    if a.wgan:
        ...
        with tf.name_scope("generator_loss"):
            ...
            if a.use_sketch_loss:
                gen_loss_sketch = tf.reduce_mean(tf.abs(fake_sketches - real_sketches))
                gen_loss = gen_loss_L1 * a.l1_weight + gen_loss_sketch * a.sketch_weight
            else:
                gen_loss = gen_loss_L1 * a.l1_weight

        with tf.name_scope("generator_train"):
            gen_tvars = [var for var in tf.trainable_variables() if var.name.startswith(
                "generator" if not a.train_sketch else SKETCH_VAR_SCOPE_PREFIX + "generator")]
            # gen_optim = tf.train.AdamOptimizer(a.lr, a.beta1)
            gen_optim = tf.train.RMSPropOptimizer(a.lr)
            gen_train = gen_optim.minimize(gen_loss, var_list=gen_tvars)
    ...
    if a.wgan:
        ...
        if a.use_sketch_loss:
            update_losses = ema.apply([gen_loss_L1, gen_loss_sketch])
        else:
    ...
    return Model(
        predict_real=predict_real if a.wgan else None,
        predict_fake=predict_fake if a.wgan else None,
        discrim_loss=ema.average(discrim_loss) if a.wgan else None,
        gen_loss_GAN=ema.average(gen_loss_GAN) if a.wgan else None,
...
def main():
    ...
    if a.from_128:
        ...
        assert len(generator_var) != 0 and (len(discriminator_var) != 0 or (not a.wgan))
...
python pix2pix_w_hint_lab_wgan.py --mode train --output_dir pixiv_downloaded_128_lab_wgan --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_128_combined/train --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --lab_colorization
python pix2pix_w_hint_lab_wgan.py --mode train --output_dir pixiv_downloaded_128_w_hint_lab --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_128_combined/train --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --no_wgan
python pix2pix_w_hint_lab_wgan.py --mode train --output_dir pixiv_downloaded_128_w_hint_lab_wgan_sketch_10 --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_128_combined/train --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --sketch_weight=10
...
python pix2pix_w_hint_lab_wgan.py --mode train --output_dir pixiv_full_128_to_sketch_train --max_epochs 20 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/train --which_direction BtoA --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.002 --gpu_percentage 0.45 --scale_size=143 --crop_size=128

python pix2pix_w_hint_lab_wgan.py --mode train --output_dir pixiv_full_128_to_sketch_train --max_epochs 20 --input_dir /mnt/tf_drive/home/ubuntu/pixiv_full_128_combined/train --which_direction BtoA --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.002 --gpu_percentage 0.45 --scale_size=143 --crop_size=128 --train_sketch
# Test
...
python pix2pix_w_hint_lab_wgan.py --mode test --output_dir pixiv_downloaded_512_w_hint_lab_wgan_test_with_hint --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_512_combined/test --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=572 --crop_size=512 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --checkpoint=pixiv_downloaded_512_w_hint_lab_wgan
python pix2pix_w_hint_lab_wgan.py --mode test --output_dir pixiv_downloaded_512_w_hint_lab_wgan_test_no_hint --max_epochs 20 --input_dir /mnt/data_drive/home/ubuntu/pixiv_downloaded_sketches_lnet_512_combined/test --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 4 --lr 0.0008 --gpu_percentage 0.45 --scale_size=572 --crop_size=512 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --checkpoint=pixiv_downloaded_512_w_hint_lab_wgan --user_hint_path=BLANK
python pix2pix_w_hint_lab_wgan.py --mode test --output_dir sketches_combined_w_hint_lab_wgan_test_with_hint --max_epochs 20 --input_dir sketches_combined --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 1 --lr 0.0008 --gpu_percentage 0.45 --scale_size=572 --crop_size=512 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --checkpoint=pixiv_downloaded_512_w_hint_lab_wgan
python pix2pix_w_hint_lab_wgan.py --mode test --output_dir sketches_combined_w_hint_lab_wgan_test_no_hint --max_epochs 20 --input_dir sketches_combined --which_direction AtoB --display_freq=1000 --gray_input_a --batch_size 1 --lr 0.0008 --gpu_percentage 0.45 --scale_size=572 --crop_size=512 --use_sketch_loss --pretrained_sketch_net_path pixiv_full_128_to_sketch_train --use_hint --lab_colorization --checkpoint=pixiv_downloaded_512_w_hint_lab_wgan --user_hint_path=BLANK
"""
